...
public class c5_CreatingSequence {
    ...
    public void repeat() {
        ...
        Flux<Integer> repeated = Flux.just(counter)
    ...
    public void generate_programmatically() throws InterruptedException {
        ...
        //------------------------------------------------------
        AtomicReference<Consumer<List<Integer>>> consumer = new AtomicReference<>();
        ...
        Thread thread1 = new Thread(() -> consumer.get().accept(List.of(1,2,3,4,5)));
