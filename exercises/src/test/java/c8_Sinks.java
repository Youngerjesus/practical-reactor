...
public class c8_Sinks extends SinksBase {
    ...
    public void it_gets_crowded() {
        ...
        submitOperation(() -> {
            ...
            List<Integer> measures_readings = get_measures_readings(); //don't change this line
            measures_readings.forEach(sinks::tryEmitNext);
    ...
    public void emit_failure() {
        ...
        for (int i = 1; i <= 50; i++) {
            int finalI = i;
            new Thread(() -> {
                sink.emitNext(finalI, ((signalType, emitResult) -> emitResult.equals(Sinks.EmitResult.FAIL_NON_SERIALIZED)));
            }).start();
        }
